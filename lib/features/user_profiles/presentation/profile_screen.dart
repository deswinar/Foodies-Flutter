    ...
    return Scaffold(
      ...
      body: BlocBuilder<ProfileBloc, ProfileState>(
        builder: (context, state) {
          // throw(getIt<FirebaseAuth>().currentUser?.email??'');
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: ProfileImageWidget(
                        initialSource: user
                            .photoURL!, // Cloudinary public ID or network URL
                        size: 100, // Circular size (diameter)
                        placeholder:
                            const Center(child: CircularProgressIndicator()),
                        errorWidget: const Icon(Icons.account_circle,
                            size:
                                80), // Toggle between Cloudinary or network image
                      ),
                    ),
